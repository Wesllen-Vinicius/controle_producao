      ...
      {hasProductFilter ? (
        <View style={{ gap: spacing.md }}>
          <View style={styles.metricsContainer}>
            ...
            <Metric
              label="Meta"
              value={formatNumber(item.meta)}
              color={colors.text}
              align="center"
            />
            <Metric
              label={item.diff >= 0 ? 'Excesso' : 'Déficit'}
              value={formatNumber(Math.abs(item.diff))}
          ...
          <View>
            ...
            <View style={styles.progressLabelContainer}>
              ...
              <Text style={[styles.progressValue, { color: performanceColor }]}>
...
const styles = StyleSheet.create({
  container: {
    ...
    gap: 12,
    ...Platform.select({
      ios: { shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.06, shadowRadius: 5 },
      android: { elevation: 2 },
    }),
  },
